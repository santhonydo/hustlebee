<a href="https://github.com/stormpath/stormpath-sdk-angularjs/edit/master/./src/stormpath.user.js" class="improve-docs"><i class="icon-edit"> </i>Improve this doc</a><a href="https://github.com/stormpath/stormpath-sdk-angularjs/blob/ac251ea/./src/stormpath.user.js#L37" class="view-source"><i class="icon-eye-open"> </i>View source</a><h1><code ng:non-bindable="">$user</code>
...
<ul class="methods"><li><a href="https://github.com/stormpath/stormpath-sdk-angularjs/blob/ac251ea/./src/stormpath.user.js#L163" class="view-source icon-eye-open"> </a><h3 id="methods_create">create(accountData)</h3>
...
<li><a href="https://github.com/stormpath/stormpath-sdk-angularjs/blob/ac251ea/./src/stormpath.user.js#L220" class="view-source icon-eye-open"> </a><h3 id="methods_get">get()</h3>
...
object, which is wrapped by a <a href="#/api/eh">User</a> type.</p>
</div><h5 id="methods_get_returns">Returns</h5><table class="variables-matrix"><tr><td><a href="" class="label type-hint type-hint-promise">promise</a></td><td><div class="get-page"><p>A promise representing the operation to get the current user data.</p>
...
<li><a href="https://github.com/stormpath/stormpath-sdk-angularjs/blob/ac251ea/./src/stormpath.user.js#L375" class="view-source icon-eye-open"> </a><h3 id="methods_passwordresetrequest">passwordResetRequest(data)</h3>
...
<li><a href="https://github.com/stormpath/stormpath-sdk-angularjs/blob/ac251ea/./src/stormpath.user.js#L277" class="view-source icon-eye-open"> </a><h3 id="methods_resendverificationemail">resendVerificationEmail(data)</h3>
...
<li><a href="https://github.com/stormpath/stormpath-sdk-angularjs/blob/ac251ea/./src/stormpath.user.js#L415" class="view-source icon-eye-open"> </a><h3 id="methods_resetpassword">resetPassword(token, data)</h3>
...
<li><a href="https://github.com/stormpath/stormpath-sdk-angularjs/blob/ac251ea/./src/stormpath.user.js#L313" class="view-source icon-eye-open"> </a><h3 id="methods_verify">verify(data)</h3>
<div class="verify"><div class="verify-page"><p>Verifies a new account, using the <code>sptoken</code> that was sent to the user
by email.</p>
</div><h5 id="methods_verify_parameters">Parameters</h5><table class="variables-matrix table table-bordered table-striped"><thead><tr><th>Param</th><th>Type</th><th>Details</th></tr></thead><tbody><tr><td>data</td><td><a href="" class="label type-hint type-hint-object">Object</a></td><td><div class="verify-page"><p>Data object</p>
<p>An object literal for passing the email verification token.
Must follow this format:</p>
<pre><code>{
  sptoken: &#39;&lt;token from email&gt;&#39;
}
</code></pre></div></td></tr></tbody></table><h5 id="methods_verify_returns">Returns</h5><table class="variables-matrix"><tr><td><a href="" class="label type-hint type-hint-promise">promise</a></td><td><div class="verify-page"><p>An $http promise representing the operation to verify the given
...
<li><a href="https://github.com/stormpath/stormpath-sdk-angularjs/blob/ac251ea/./src/stormpath.user.js#L345" class="view-source icon-eye-open"> </a><h3 id="methods_verifypasswordresettoken">verifyPasswordResetToken(sptoken)</h3>
...
<div class="currentuser"><div class="currentuser-page"><p>Retains the account object of the currently logged in user.</p>
<p>If the user state is unknown, this value is <code>null</code>.</p>
<p>If the user state is known and the user is not logged in
(<a href="#/api/stormpath.userService.$user#methods_get">$user.get()</a> has
been called, and rejected) then this value will be <code>false</code>.</p>
</div></div>
</li>
</ul>
</div>
