<a href="https://github.com/stormpath/stormpath-sdk-angularjs/edit/master/./src/stormpath.auth.js" class="improve-docs"><i class="icon-edit"> </i>Improve this doc</a><a href="https://github.com/stormpath/stormpath-sdk-angularjs/blob/ac251ea/./src/stormpath.auth.js#L36" class="view-source"><i class="icon-eye-open"> </i>View source</a><h1><code ng:non-bindable="">$auth</code>
...
<ul class="methods"><li><a href="https://github.com/stormpath/stormpath-sdk-angularjs/blob/ac251ea/./src/stormpath.auth.js#L120" class="view-source icon-eye-open"> </a><h3 id="methods_authenticate">authenticate(credentialData)</h3>
...
<li><a href="https://github.com/stormpath/stormpath-sdk-angularjs/blob/ac251ea/./src/stormpath.auth.js#L173" class="view-source icon-eye-open"> </a><h3 id="methods_endsession">endSession()</h3>
