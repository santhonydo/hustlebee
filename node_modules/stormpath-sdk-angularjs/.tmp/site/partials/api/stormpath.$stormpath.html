<a href="https://github.com/stormpath/stormpath-sdk-angularjs/edit/master/./src/module.js" class="improve-docs"><i class="icon-edit"> </i>Improve this doc</a><a href="https://github.com/stormpath/stormpath-sdk-angularjs/blob/ac251ea/./src/module.js#L198" class="view-source"><i class="icon-eye-open"> </i>View source</a><h1><code ng:non-bindable="">$stormpath</code>
...
<ul class="methods"><li><a href="https://github.com/stormpath/stormpath-sdk-angularjs/blob/ac251ea/./src/module.js#L652" class="view-source icon-eye-open"> </a><h3 id="methods_ngrouter">ngRouter(config)</h3>
<div class="ngrouter"><div class="stormpath-ngrouter-page"><p>Call this method to enable the integration with the ngRoute module.</p>
<p>When enabled, you can define <a href="#/api/stormpath.SpRouteConfig:SpRouteConfig">Stormpath Route Configurations</a> on your routes.
This object allows you to define access control for the route.</p>
...
</div><h5 id="methods_ngrouter_parameters">Parameters</h5><table class="variables-matrix table table-bordered table-striped"><thead><tr><th>Param</th><th>Type</th><th>Details</th></tr></thead><tbody><tr><td>config</td><td><a href="" class="label type-hint type-hint-object">object</a></td><td><div class="stormpath-ngrouter-page"><ul>
<li><p><strong><code>autoRedirect</code></strong> - Defaults to true.  After the user logs in at
the route defined by <code>loginRoute</code>, they will be redirected back to the
route that was originally requested.</p>
</li>
<li><p><strong><code>defaultPostLoginRoute</code></strong>  - Where the user should be sent, after login,
...
<li><p><strong><code>forbiddenRoute</code></strong> - The route that we should send the user
...
<a href="#/api/stormpath.SpRouteConfig:SpRouteConfig">Stormpath Route Configurations</a></p>
</li>
<li><p><strong><code>loginRoute</code></strong> - The route name that we should send the user
to if they need to login.  You&#39;ll probably use <code>login</code> for this value.</p>
</li>
</ul>
</div></td></tr></tbody></table><h4 id="methods_ngrouter_example">Example</h4>
<div class="example"><div class="stormpath-ngrouter-page"><pre class="prettyprint linenums">
...
<li><a href="https://github.com/stormpath/stormpath-sdk-angularjs/blob/ac251ea/./src/module.js#L567" class="view-source icon-eye-open"> </a><h3 id="methods_uirouter">uiRouter(config)</h3>
...
<ul class="events"><li><h3 id="events_$routechangeunauthenticated">$routeChangeUnauthenticated</h3>
<div class="$routechangeunauthenticated"><div class="stormpath-stormpath-routechangeunauthenticated-page"><p>This event is broadcast when a route change is prevented,
...
<p>To receive this event, you must be using the ngRoute module.</p>
</div><div class="inline"><h4 id="events_$routechangeunauthenticated_type">Type:</h4>
<div class="type">broadcast</div>
</div>
<div class="inline"><h4 id="events_$routechangeunauthenticated_target">Target:</h4>
<div class="target">root scope</div>
</div>
<h5 id="events_$routechangeunauthenticated_target_parameters">Parameters</h5><table class="variables-matrix table table-bordered table-striped"><thead><tr><th>Param</th><th>Type</th><th>Details</th></tr></thead><tbody><tr><td>event</td><td><a href="" class="label type-hint type-hint-object">Object</a></td><td><div class="stormpath-stormpath-routechangeunauthenticated-page"><p>Angular event object.</p>
</div></td></tr><tr><td>toRoute</td><td><a href="" class="label type-hint type-hint-object">Object</a></td><td><div class="stormpath-stormpath-routechangeunauthenticated-page"><p>The route that the user attempted to access.</p>
</div></td></tr></tbody></table><h4 id="events_$routechangeunauthenticated_example">Example</h4>
<div class="example"><div class="stormpath-stormpath-routechangeunauthenticated-page"><pre class="prettyprint linenums">
...
<li><h3 id="events_$routechangeunauthorized">$routeChangeUnauthorized</h3>
<div class="$routechangeunauthorized"><div class="stormpath-stormpath-routechangeunauthorized-page"><p>This event is broadcast when a route change is prevented,
because the user is not authorized by the rules defined in the
<a href="#/api/stormpath.SpRouteConfig:SpRouteConfig">Stormpath Route Configuration</a>
for the requested route.</p>
<p>Use this event if you want to implement your own strategy for telling
the user that they are forbidden from viewing that route.</p>
<p>To receive this event, you must be using the ngRoute module.</p>
</div><div class="inline"><h4 id="events_$routechangeunauthorized_type">Type:</h4>
<div class="type">broadcast</div>
</div>
<div class="inline"><h4 id="events_$routechangeunauthorized_target">Target:</h4>
<div class="target">root scope</div>
</div>
<h5 id="events_$routechangeunauthorized_target_parameters">Parameters</h5><table class="variables-matrix table table-bordered table-striped"><thead><tr><th>Param</th><th>Type</th><th>Details</th></tr></thead><tbody><tr><td>event</td><td><a href="" class="label type-hint type-hint-object">Object</a></td><td><div class="stormpath-stormpath-routechangeunauthorized-page"><p>Angular event object.</p>
</div></td></tr><tr><td>toRoute</td><td><a href="" class="label type-hint type-hint-object">Object</a></td><td><div class="stormpath-stormpath-routechangeunauthorized-page"><p>The route that the user attempted to access.</p>
</div></td></tr></tbody></table><h4 id="events_$routechangeunauthorized_example">Example</h4>
<div class="example"><div class="stormpath-stormpath-routechangeunauthorized-page"><pre class="prettyprint linenums">
...
<li><h3 id="events_$statechangeunauthenticated">$stateChangeUnauthenticated</h3>
