            ...
            findOrCreateUser = function(){
                ...
                User.findOne({ 'username' :  username }, function(err, user) {
                    ...
                    if (user) {
                        ...
                        newUser.stateOfLicensure = req.param('stateLicense');
                        newUser.licenseNumber = req.param('licenseNumber');
                        newUser.licenseExpirationDate = req.param('licenseExpirationDate');
                        newUser.status = 0;
